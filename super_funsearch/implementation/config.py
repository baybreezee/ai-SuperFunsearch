...
class KnowledgeBaseConfig:
    """Configuration for the 4-layer RAG knowledge base."""
    seed_path: str = 'seed_knowledge.json'
    embedding_model: str = 'all-MiniLM-L6-v2'
    similarity_threshold: float = 0.6
    persist_path: str = 'knowledge.json'


@dataclasses.dataclass()
class ClassConfig:
    """Configuration of class types used in this implementation."""
    llm_class: Type[sampler.LLM]
    sandbox_class: Type[evaluator.Sandbox]
    reflector_llm_class: Type[sampler.LLM] | None = None
